              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="mr-6 text-[#CED3F6] hover:text-[#08ADAD]"
                  >
                    <svg
                      width="9"
                      height="18"
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/features"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-[#08ADAD]"
                    >
                      {" "}
                      Features{" "}
                    </a>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#08ADAD" stopOpacity="0.62" />
              ...
              >
                ...
                <stop offset="1" stopColor="#08ADAD" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
