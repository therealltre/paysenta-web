          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="">
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                <Link
                  href="/"
                  className="ease-in-up mr-1 hidden rounded-md bg-[#08ADAD] py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Personal
                </Link>
                <Link
                  href="#"
                  className="hidden py-3 px-7 text-base font-bold text-dark hover:underline hover:opacity-70 dark:text-white md:block"
                >
                  Business
                </Link>
              </div>
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg px-3 py-[6px] ring-[#08ADAD] focus:ring-2 lg:hidden"
                >
                  <span
