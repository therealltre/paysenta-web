      ...
      <section className="w-full bg-[#08ADAD] mb-20" id="appDownload" >
        <div className="mx-auto h-[406px] max-w-7xl overflow-hidden rounded-2xl bg-[#08ADAD] px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-10 sm:py-16 lg:py-24 2xl:pl-24">
            <div className="grid grid-cols-1 items-center gap-y-12 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20 justify-start">
              <div className="">
                <h3 className="mb-2 text-3xl font-bold text-white md:text-white w-[400px]">
                  One Solution for All Your Cross-Border Payments
                </h3>
                <div className="mt-8 flex flex-row items-center space-x-4 lg:mt-12">
                  <a href="#/apple" title="" className="flex" role="button">
                    <img
              ...
              <div className="relative px-12">
                <img
                  className="relative mx-auto -mb-60 w-full max-w-xs lg:-mb-64"
                  src="/images/appdownloadImage.svg"
                  alt="phone model"
                />
              </div>
            </div>
